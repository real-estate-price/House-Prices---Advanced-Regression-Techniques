...
model = CatBoostRegressor(learning_rate=0.03996902268554373, max_depth=9, colsample_bylevel=0.2710787847399107,
                          boosting_type='Ordered', bootstrap_type='Bernoulli', subsample=0.10128815141985761, loss_function='RMSE', iterations=1000,
